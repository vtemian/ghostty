    ...
    return struct {
        ...
        const SwapChain = struct {
            ...
            pub fn nextFrame(self: *SwapChain) error{Defunct}!*FrameState {
                ...
                self.frame_sema.waitUncancelable(std.Io.Threaded.global_single_threaded.io());
            ...
            pub fn releaseFrame(self: *SwapChain) void {
                self.frame_sema.post(std.Io.Threaded.global_single_threaded.io());
            }
        };
        ...
        pub fn init(alloc: Allocator, options: renderer.Options) !Self {
            ...
            const font_critical: struct {
                ...
                grid.lock.lockSharedUncancelable(std.Io.Threaded.global_single_threaded.io());
                defer grid.lock.unlockShared(std.Io.Threaded.global_single_threaded.io());
                break :font_critical .{
        ...
        pub fn displayRealized(self: *Self) !void {
            ...
            self.draw_mutex.lockUncancelable(std.Io.Threaded.global_single_threaded.io());
            defer self.draw_mutex.unlock(std.Io.Threaded.global_single_threaded.io());
        ...
        pub fn updateFrame(
            ...
            var critical: Critical = critical: {
                state.mutex.lockUncancelable(std.Io.Threaded.global_single_threaded.io());
                defer state.mutex.unlock(std.Io.Threaded.global_single_threaded.io());
        ...
        pub fn drawFrame(
            ...
            texture: {
                ...
                self.font_grid.lock.lockSharedUncancelable(std.Io.Threaded.global_single_threaded.io());
                defer self.font_grid.lock.unlockShared(std.Io.Threaded.global_single_threaded.io());
